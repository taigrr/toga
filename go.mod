...
require (
	...
	github.com/taigrr/log-socket/v2 v2.5.0
...
// minio-go still depends on the old path, but go-ini/ini v1.67.1 declares gopkg.in/ini.v1
replace github.com/go-ini/ini v1.67.1 => github.com/go-ini/ini v1.67.0
